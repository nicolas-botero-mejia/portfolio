...
export default function HomeClient({ featuredWork }: HomeClientProps) {
  ...
  const handleContactClick = (method: 'email' | 'linkedin', section: string) => {
    trackEvent({
      name: 'contact_click',
      properties: { method, section },
    });
  };
        ...
        <div className="space-y-6">
          {featuredWork.map((work, index) => (
            <Link
              ...
              onClick={() => handleWorkCardClick(work.slug, work.frontmatter.title, index)}
            >
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center mb-12">
            <a
              ...
              onClick={() => handleContactClick('email', 'hero')}
            >
            ...
            <a
              ...
              onClick={() => handleContactClick('linkedin', 'hero')}
            >
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <a 
                  ...
                  onClick={() => handleContactClick('email', 'footer')}
                >
                  n.boterom@gmail.com
                </a>
              </div>
              ...
              <div>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-sm text-gray-600 hover:text-gray-900"
                  onClick={() => handleContactClick('linkedin', 'footer')}
                >
